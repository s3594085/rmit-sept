      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form id="addnewemp" role="form" method="POST" action="{{ route('create_employee') }}">
            ...
            <!--
            <div id="availability" style="text-align:left;">
              <h5>Availability</h5>
              <textarea name="message" rows="4" cols="60" class="form-control"></textarea>
            </div>
            <br>
            <div id="time" style="text-align:left;">
              <strong>Day</strong>
              ...
              <select class='form-control'><option value="00">00</option>
                <option value="15">15</option>
